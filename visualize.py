...
# Code from https://github.com/CodeReclaimers/neat-python/blob/master/examples/xor/visualize.py
import graphviz
...
def plot_spikes(spikes, view=False, filename=None, title=None, file_dir=None):
...
def plot_species(statistics, view=False, filename='speciation.svg', file_dir=None):
...
def draw_net(config, genome, view=False, filename=None, node_names=None, show_disabled=True, prune_unused=False,
             node_colors=None, fmt='svg', file_dir=None):
    ...
    dot.render(file_dir + filename, view=view)
