...
# Init experiment
experiment_name = 'simple_ea_generalized_agent'
...
def two_point_crossover(population: np.ndarray)->np.ndarray:
    ...
    for i in range(n_population // 2):
        ...
        lb = round(n_weights/3)
        ub = n_weights - round(n_weights/3)
        gene_seq_1 = child_1[lb:ub]
        gene_seq_2 = child_2[lb:ub]
        child_1[lb:ub] = gene_seq_2
        child_2[lb:ub] = gene_seq_1
